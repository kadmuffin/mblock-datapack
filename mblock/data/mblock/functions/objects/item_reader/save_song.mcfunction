...
execute at @e[tag=music_player,sort=nearest,limit=1] align xyz positioned ~.5 ~.5 ~.5 run summon item ~ ~ ~ {Tags:[new_song,_saved],Item:{id:"minecraft:note_block",Count:1b,tag:{contains_song:1b,data:{notes:[],events:[]},z_data:[],tmp_events:[],tmp:{tone:-1,sound:-1},song:{bpm:-1,xsize:-1,ysize:-1,zsize:-1,array_size:-1},display:{Name:"\"§7My Song!\"",Lore:["\"§6Song BPM:\"","\"Unknown\"","\"§6Travel Time:\"","\"Unknown\"","\"§6Stored Elements:\"","\"Unknown\""]}}},PickupDelay:-32768s,NoGravity:1b}
