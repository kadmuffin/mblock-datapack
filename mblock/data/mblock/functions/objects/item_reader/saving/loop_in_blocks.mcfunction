...
execute as @s[tag=!end_recursion,tag=counting_air] if block ~ ~ ~ #mblock:soundable run tag @s add soundable_in_air
...
execute as @s[tag=!end_recursion,tag=counting_air] unless score #tone _mbtmp matches -1 if entity @s[tag=soundable_in_air] run data modify entity @s Item.tag.tmp.has_soundable set value 1b
execute as @s[tag=!end_recursion,tag=counting_air] unless score #tone _mbtmp matches -1 run data modify entity @s Item.tag.z_data append from entity @s Item.tag.tmp
...
execute as @s[tag=!end_recursion,tag=counting_air] if score @s aparse.zsize <= estimated_zsize _array_tmp if entity @s[tag=soundable_in_air] run data modify entity @s Item.tag.tmp.has_soundable set value 1b
execute as @s[tag=!end_recursion,tag=counting_air] if score @s aparse.zsize <= estimated_zsize _array_tmp run data modify entity @s Item.tag.z_data append from entity @s Item.tag.tmp
...
execute as @s[tag=!end_recursion,tag=counting_air] if block ~ ~ ~ magenta_glazed_terracotta if entity @s[tag=soundable_in_air] run data modify entity @s Item.tag.tmp.has_soundable set value 1b
execute as @s[tag=!end_recursion,tag=counting_air] if block ~ ~ ~ magenta_glazed_terracotta run data modify entity @s Item.tag.z_data append from entity @s Item.tag.tmp
...
execute as @s[tag=!end_recursion,tag=counting_air] if block ~ ~ ~ black_glazed_terracotta if entity @s[tag=soundable_in_air] run data modify entity @s Item.tag.tmp.has_soundable set value 1b
execute as @s[tag=!end_recursion,tag=counting_air] if block ~ ~ ~ black_glazed_terracotta run data modify entity @s Item.tag.z_data append from entity @s Item.tag.tmp
...
execute as @s[tag=!end_recursion,tag=counting_air] if block ~ ~ ~ purple_glazed_terracotta if entity @s[tag=soundable_in_air] run data modify entity @s Item.tag.tmp.has_soundable set value 1b
execute as @s[tag=!end_recursion,tag=counting_air] if block ~ ~ ~ purple_glazed_terracotta run data modify entity @s Item.tag.z_data append from entity @s Item.tag.tmp
...
execute if block ~ ~ ~ black_glazed_terracotta run data modify entity @s Item.tag.z_data append value {event: 1}
execute if block ~ ~ ~ purple_glazed_terracotta run tag @s add end_recursion
execute if block ~ ~ ~ purple_glazed_terracotta run data modify entity @s Item.tag.z_data append value {event: 2}
...
execute if block ~ ~ ~ magenta_glazed_terracotta run data modify entity @s Item.tag.z_data append from entity @s Item.tag.tmp
...
execute as @s[tag=!end_recursion] unless score #tone _mbtmp matches -1 if score #sound _mbtmp matches 1.. if score #sound_dir _mbtmp matches 0.. store result entity @s Item.tag.tmp.sound_dir int 1 run scoreboard players get #sound_dir _mbtmp
...
execute as @s[tag=!end_recursion] unless score #tone _mbtmp matches -1 run data modify entity @s Item.tag.z_data append from entity @s Item.tag.tmp
