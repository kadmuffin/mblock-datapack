...
execute store result entity @s Item.tag.tmp.dir int 1 run scoreboard players get @s _aparse_tmp5
#data modify entity @s Item.tag.z_data append from entity @s Item.tag.tmp
execute store result entity @s Item.tag.tmp.z_pos int 1 run scoreboard players get internal_zsize _array_tmp
