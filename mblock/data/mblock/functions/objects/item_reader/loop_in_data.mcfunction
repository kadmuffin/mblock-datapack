...
execute as @s[tag=!counting_air,tag=!counting_tone] unless data entity @s Item.tag.z_data[0].sound_dir unless score #sound_dir _mbtmp matches 0.. unless block ~ ~-1 ~ #mblock:octaves unless block ~ ~-1 ~ #mblock:soundable run scoreboard players set #sound_dir _mbtmp 0
execute as @s[tag=!counting_air,tag=!counting_tone] unless data entity @s Item.tag.z_data[0].sound_dir unless score #sound_dir _mbtmp matches 0.. unless block ~ ~1 ~ #mblock:octaves unless block ~ ~1 ~ #mblock:soundable run scoreboard players set #sound_dir _mbtmp 1
...
execute as @s[tag=!counting_air,tag=!counting_tone] unless data entity @s Item.tag.z_data[0].sound_dir unless score #sound_dir _mbtmp matches 0.. unless block ~1 ~ ~ #mblock:octaves unless block ~1 ~ ~ #mblock:soundable run scoreboard players set #sound_dir _mbtmp 2
execute as @s[tag=!counting_air,tag=!counting_tone] unless data entity @s Item.tag.z_data[0].sound_dir unless score #sound_dir _mbtmp matches 0.. unless block ~-1 ~ ~ #mblock:octaves unless block ~-1 ~ ~ #mblock:soundable run scoreboard players set #sound_dir _mbtmp 3
execute as @s[tag=!counting_air,tag=!counting_tone] unless data entity @s Item.tag.z_data[0].sound_dir unless score #sound_dir _mbtmp matches 0.. unless block ~ ~ ~1 #mblock:octaves unless block ~ ~ ~1 #mblock:soundable run scoreboard players set #sound_dir _mbtmp 4
execute as @s[tag=!counting_air,tag=!counting_tone] unless data entity @s Item.tag.z_data[0].sound_dir unless score #sound_dir _mbtmp matches 0.. unless block ~ ~ ~-1 #mblock:octaves unless block ~ ~ ~-1 #mblock:soundable run scoreboard players set #sound_dir _mbtmp 5
