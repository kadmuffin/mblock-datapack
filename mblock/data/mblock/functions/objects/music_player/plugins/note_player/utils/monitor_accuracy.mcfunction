...
execute as @s[tag=!invalid_pos] unless score @s mb.bpm_accuracy = #last_accuracy mb.bpm_accuracy if score @s mb.bpm_accuracy > @s mb.max_accuracy run scoreboard players operation @s mb.bpm_accuracy = @s mb.max_accuracy
