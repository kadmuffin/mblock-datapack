...
execute as @s positioned ~ ~1 ~ run function mblock:objects/music_player/plugins/note_player/utils/block_events
execute as @s[tag=!disable_extended] run function mblock:objects/music_player/plugins/note_player/utils/run_when_extended
