...
execute as @s[tag=!not_update,tag=!disable_extended] positioned ~ ~ ~ run function mblock:objects/music_player/plugins/note_player/utils/block_events
execute as @s[tag=!not_update] positioned ~ ~1 ~ run function mblock:objects/music_player/plugins/note_player/utils/block_events
execute as @s[tag=!not_update,tag=!disable_extended] positioned ~ ~2 ~ run function mblock:objects/music_player/plugins/note_player/utils/block_events
