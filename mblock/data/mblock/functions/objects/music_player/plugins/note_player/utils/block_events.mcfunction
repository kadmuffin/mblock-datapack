...
execute as @s[tag=note_player_center] at @s positioned ~ ~1 ~ if block ~ ~ ~ blue_glazed_terracotta run function mblock:objects/music_player/plugins/note_player/block_events/blue_glazed_terracotta
