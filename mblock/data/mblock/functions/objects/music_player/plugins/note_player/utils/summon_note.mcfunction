execute align xyz positioned ~.5 ~.5 ~.5 if block ~ ~ ~ #mblock:octaves unless entity @e[tag=_note,distance=0..0.5] run function mblock:objects/music_player/plugins/note_player/block_events/mblock_octaves
