...
execute as @s[tag=instant_start,tag=!look_neg,scores={aparse.dir=0}] align xz positioned ~.5 ~ ~.5 positioned ~ ~ ~2.2 run function mblock:objects/area_parser/run_instant
execute as @s[tag=instant_start,tag=look_neg,scores={aparse.dir=0}] align xz positioned ~.5 ~ ~.5 positioned ~ ~ ~-2.2 run function mblock:objects/area_parser/run_instant
execute as @s[tag=instant_start,tag=!look_neg,scores={aparse.dir=1}] align xz positioned ~.5 ~ ~.5 positioned ~2.2 ~ ~ run function mblock:objects/area_parser/run_instant
execute as @s[tag=instant_start,tag=look_neg,scores={aparse.dir=1}] align xz positioned ~.5 ~ ~.5 positioned ~-2.2 ~ ~ run function mblock:objects/area_parser/run_instant

execute as @s[tag=!instant_start,tag=!look_neg,scores={aparse.dir=0}] align xz positioned ~.5 ~ ~.5 positioned ~ ~ ~1.3 run function mblock:objects/area_parser/run_instant
execute as @s[tag=!instant_start,tag=look_neg,scores={aparse.dir=0}] align xz positioned ~.5 ~ ~.5 positioned ~ ~ ~-1.3 run function mblock:objects/area_parser/run_instant
execute as @s[tag=!instant_start,tag=!look_neg,scores={aparse.dir=1}] align xz positioned ~.5 ~ ~.5 positioned ~1.3 ~ ~ run function mblock:objects/area_parser/run_instant
execute as @s[tag=!instant_start,tag=look_neg,scores={aparse.dir=1}] align xz positioned ~.5 ~ ~.5 positioned ~-1.3 ~ ~ run function mblock:objects/area_parser/run_instant
