execute as @s[tag=light_render_center] unless block ~ ~1 ~ bedrock unless block ~ ~-1 ~ bedrock run summon minecraft:area_effect_cloud ~ ~ ~ {Tags: ["_note_lg", "_note", "new_note"], Age: -32760, Particle: "block air"}
