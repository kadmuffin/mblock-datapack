scoreboard players operation @s mb_tpm2 = @e[tag=forcing,sort=nearest,limit=1] mb_tmp2
...
execute at @s as @e[tag=note_player,tag=!center_block] if score @s mb_id = @e[tag=center_player,sort=nearest,limit=1] mb_id run kill @s
