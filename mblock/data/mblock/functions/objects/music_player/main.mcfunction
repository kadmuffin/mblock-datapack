scoreboard players add #tick _aparse.tmp3 1
...
execute if score #tick _aparse.tmp3 matches 10.. run function mblock:objects/music_player/xyz_private/run_var_update_and_menu
execute if score #tick _aparse.tmp3 matches 10.. run scoreboard players reset #tick mb_tmp
