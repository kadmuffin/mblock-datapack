...
execute if score #external_sounds _mbtmp matches 1.. positioned ~ ~-1 ~ align xyz positioned ~.5 ~.5 ~.5 unless block ~ ~-1 ~ #mblock:soundable if block ~ ~ ~ #mbe_sound:soundable run function mblock:block/get_sound_dir
