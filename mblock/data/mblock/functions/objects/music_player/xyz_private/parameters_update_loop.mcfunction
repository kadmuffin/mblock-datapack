...
execute at @s as @e[type=item,distance=0..1,limit=1,nbt={Item:{id:"minecraft:enchanted_book"}},nbt={Item:{tag:{contains_song:1b}}},tag=!_loaded,tag=!_saved] at @s run function mblock:objects/music_player/plugins/item_events/note_block_load
