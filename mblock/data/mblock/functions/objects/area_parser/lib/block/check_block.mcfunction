...
execute as @s[tag=on_bottom,tag=!on_end,tag=!on_side] if block ~ ~ ~ black_glazed_terracotta at @s unless block ~ ~ ~ black_glazed_terracotta run particle minecraft:totem_of_undying ~ ~1 ~ 0 0.3 0 0 4
execute as @s[tag=on_bottom,tag=!on_end,tag=!on_side] if block ~ ~ ~ magenta_glazed_terracotta at @s unless block ~ ~ ~ magenta_glazed_terracotta run particle minecraft:totem_of_undying ~ ~1 ~ 0 0.3 0 0 4
execute as @s[tag=on_bottom,tag=!on_end,tag=!on_side] if block ~ ~ ~ purple_glazed_terracotta at @s unless block ~ ~ ~ magenta_glazed_terracotta run particle minecraft:totem_of_undying ~ ~1 ~ 0 0.3 0 0 4
