execute if entity @s[tag=!getting_tone,tag=!sneaking] run scoreboard players add #tone _mbtmp 1
execute if entity @s[tag=!getting_tone,tag=!sneaking] run particle minecraft:end_rod ~ ~1.3 ~ 0 0 0 0.05 1
execute if entity @s[tag=!getting_tone,tag=sneaking] run scoreboard players remove #tone _mbtmp 1
