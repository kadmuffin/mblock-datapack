...
execute as @a[nbt={SelectedItem: {tag: {note_wand_inverted: 1b}}}] at @s run function mblock:objects/note_wand/xyz_private/main_hand_inverted
execute as @a[nbt={Inventory: [{Slot: -106b, tag: {note_wand_inverted: 1b}}]}] at @s run function mblock:objects/note_wand/xyz_private/off_hand_inverted
