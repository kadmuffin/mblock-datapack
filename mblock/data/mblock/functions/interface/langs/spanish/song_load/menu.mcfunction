...
execute if entity @e[tag=z_pointer,tag=!pause_process] run tellraw @s ["",{"text": " "},{"text": " ▶ Pausar", "color": "blue", "clickEvent": {"action": "run_command","value": "/tag @e[tag=z_pointer] add pause_process"}},{"text": "    "},{"text": "[x] Detener", "color": "light_purple", "clickEvent": {"action": "run_command","value": "/function song_load:method/cancel"}}]
execute if entity @e[tag=z_pointer,tag=pause_process] run tellraw @s ["",{"text": " "},{"text": " ▶ Continuar", "color": "gold", "clickEvent": {"action": "run_command","value": "/tag @e[tag=z_pointer] remove pause_process"}},{"text": "    "},{"text": "[x] Detener", "color": "light_purple", "clickEvent": {"action": "run_command","value": "/function song_load:method/cancel"}}]
