tellraw @s {"text": "Do you want to load this song?","color": "gray"}
...
tellraw @s ["",{"text": " "},{"text": "[Load]", "color": "green", "clickEvent": {"action": "run_command","value": "/function song_load:utils/method/continue_load"}},{"text": "  "},{"text": "[Cancel]", "color": "red", "clickEvent": {"action": "run_command","value": "/function song_load:method/cancel"}}]