...
execute as @a[scores={mb.menu.bpm=-2..}] if entity @e[tag=music_player] run playsound minecraft:block.barrel.close block @s ~ ~ ~ 0.4 1.3
...
execute as @a[scores={mb.menu.zsize=-2..}] if entity @e[tag=music_player] run playsound minecraft:block.barrel.close block @s ~ ~ ~ 0.4 1.6
...
execute as @a[scores={mb.menu.ysize=-2..14}] if entity @e[tag=music_player] run playsound minecraft:block.barrel.close block @s ~ ~ ~ 0.4 1.6
...
execute as @a[scores={mb.menu.xsize=-2..14}] if entity @e[tag=music_player] run playsound minecraft:block.barrel.close block @s ~ ~ ~ 0.4 1.6
