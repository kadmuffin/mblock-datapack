...
execute if score .trigger mb.menu.page matches 15.. run scoreboard players set .trigger mb.menu.page 0
scoreboard players add .tick mb.menu.page 1
scoreboard players add .trigger mb.menu.page 1
...
execute unless entity @e[tag=music_player] run scoreboard players reset @a mb_id
execute if score .tick mb.menu.page matches 6.. run function mblock:interface/utils/other_triggers
execute if score .trigger mb.menu.page matches 14.. as @a at @s if entity @e[tag=music_player] run function mblock:interface/loop/trigger
