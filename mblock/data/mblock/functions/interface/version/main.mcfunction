# Datapack version (x.y.z) -> (v0.8.1)
scoreboard players set #version_x_tmp _mbtmp 0
scoreboard players set #version_y_tmp _mbtmp 8
scoreboard players set #version_z_tmp _mbtmp 1

execute if score schedule_y _aparse_tmp matches 0.. run function mblock:interface/version/x_private/v0.7.0
