...
execute if score #tone _mbtmp matches ..11 run schedule function mblock:sound/play_test 3t
execute unless score #tone _mbtmp matches ..11 run tag @a remove _schedule