...
execute as @s at @s positioned ^.5 ^.5 ^ align xyz positioned ~.5 ~ ~.5 run function mblock:block/player/play_block
execute as @s at @s positioned ^-.5 ^.5 ^ align xyz positioned ~.5 ~ ~.5 run function mblock:block/player/play_block
execute as @s at @s positioned ^1 ^.5 ^ align xyz positioned ~.5 ~ ~.5 run function mblock:block/player/play_block
execute as @s at @s positioned ^-1 ^.5 ^ align xyz positioned ~.5 ~ ~.5 run function mblock:block/player/play_block
