...
execute as @s[nbt={OnGround:0b},gamemode=!survival,gamemode=!adventure] at @s positioned ~ ~-.45 ~ align xz positioned ~.5 ~ ~.5 if block ~ ~ ~ #mblock:octaves align y positioned ~ ~.5 ~ run function mblock:block/player/play_block
