...
execute if score #block_is_valid _mbtmp matches 1 unless block ~ ~1 ~ obsidian unless block ~ ~-1 ~ obsidian run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["_block"],Age:-32760s,Particle:"block air"}
