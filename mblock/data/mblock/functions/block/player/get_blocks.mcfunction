...
execute as @s at @s run summon armor_stand ~ ~ ~ {Tags:["player","player_child"],NoGravity:1b,Invisible:1b,Small:1b,ArmorItems:[{},{},{},{id: "light_blue_concrete",Count:1b}],DisabledSlots:72689}
