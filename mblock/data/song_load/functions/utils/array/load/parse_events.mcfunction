...
#function song_load:utils/array/load/x_private/parse_events/x_cl
...
#execute if score #events_length sload_tmp matches 1.. run function song_load:utils/array/load/timers/parse_events
