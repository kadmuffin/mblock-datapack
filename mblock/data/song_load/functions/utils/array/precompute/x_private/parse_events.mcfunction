...
execute as @s[tag=!fail_at_parse] run function song_load:utils/array/precompute/x_private/parse_events/cycle_x
#execute as @s[tag=!fail_at_parse] run function song_load:utils/array/precompute/x_private/parse_events/x_cl
