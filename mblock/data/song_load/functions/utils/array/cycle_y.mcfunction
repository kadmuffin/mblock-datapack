...
data modify entity @e[tag=z_pointer,limit=1] ArmorItems[3].tag.data.events[0] append from entity @e[tag=z_pointer,limit=1] ArmorItems[3].tag.data.events[0][0]
data remove entity @e[tag=z_pointer,limit=1] ArmorItems[3].tag.data.events[0][0]
