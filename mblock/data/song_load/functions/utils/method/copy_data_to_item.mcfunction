...
summon item ~ ~ ~ {Item: {id: "enchanted_book", Count: 1b, tag: {contains_song: 1b, song: {xsize: -1, ysize: -1, zsize: -1, bpm: -1, signature: [4, 4], comp_bpm: 1b, nbs_bpm: 1b}, display: {Name: '"§bMy Song!"', Lore: ['"§7Song BPM:"', '"§9Unknown"', '"§7Song Size:"', '"§9Unknown"']}}}, Tags: [saved_song, _saved], PickupDelay: 0s}
