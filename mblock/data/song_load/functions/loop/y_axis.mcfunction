...
execute as @s at @s unless score @s sload >= song_ysize sload if score @s sload_run < maxRuns_y sload_run unless score @s sload_run matches 50.. run function song_load:loop/y_axis